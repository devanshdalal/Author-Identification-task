...
dataset_path = '/home/abhishek/Desktop/nlp_project/lstm/onevsall/';
...
def main():
	...
	for i, author in enumerate(authors):
		...
		if(i == author_taken):
			train_y = train_y + [1]*len(train_x_plus);
		else:
			train_y = train_y + [0]*len(train_x_plus);
	...
	for i, author in enumerate(authors):
		...
		if(i == author_taken):
			test_y = test_y + [1]*len(test_x_plus);
		else:
			test_y = test_y + [0]*len(test_x_plus);

	f = open('author' + str(author_taken) + '.pkl', 'wb')
	pkl.dump((train_x, train_y), f, -1)
	pkl.dump((test_x, test_y), f, -1)
	f.close()

	f = open('author' + str(author_taken) + '.dict.pkl', 'wb')
